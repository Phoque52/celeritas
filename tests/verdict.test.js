...
test('a connection with lag spikes is unstable, not slow', () => {
  ...
  // Still unstable at a moderate delay: jitter is what rules out calls.
  assert.equal(verdict({ median: 124, jitter: 68, loss: 0 }).grade, 'unstable');
});
